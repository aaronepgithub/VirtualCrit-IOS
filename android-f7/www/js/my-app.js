...
$$('#TIRESIZE').on('click', function(e) {
  if (wheelCircumference == 2105) {
    $$(this).html('<div class="item-media"><i class="icon icon-f7"></i></div><div class="item-inner"><div class="item-title">TIRE SIZE</div><div class="item-after"><span class="badge">700X32</span></div></div>');
