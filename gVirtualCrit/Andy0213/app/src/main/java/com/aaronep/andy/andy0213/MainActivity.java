package com.aaronep.andy.andy0213;
...
//                }
    ...
    // GATT CALLBACK  |  DEVICE CONNECT CALLLBACK
...
//                    peripheralTextView.append("device read or wrote to\n");
                    Log.i("CHARACTERISTIC CHANGED", "DEVICE READ/WROTE TO");
                }
            });
        }
        ...
        public void onConnectionStateChange(final BluetoothGatt gatt, final int status, final int newState) {
            ...
            switch (newState) {
                case 0:
                    MainActivity.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Log.i("CONNECTION STATE CHANGE", "DEVICE DISCONNECTED");
...
//                            disconnectDevice.setVisibility(View.INVISIBLE);
                ...
                case 2:
                    MainActivity.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Log.i("CONNECTION STATE CHANGE", "DEVICE CONNECTED");
...
//                            peripheralTextView.append("we encounterned an unknown state, uh oh\n");
                            Log.i("CONNECTION STATE CHANGE", "UNKNOWN STATE");
                        }
                    });
                    break;
            }
...
//                    peripheralTextView.append("device services have been discovered\n");
                    Log.i("CONNECTION STATE CHANGE", "DEVICES SERVICES DISCOVERED");
                }
            });
...
//                        peripheralTextView.append("Characteristic discovered for service: "+charUuid+"\n");
                        Log.i("CHAR DISCOVERED", "CHARACTERISTIC/SERVICE:  " + charUuid);
                    }
                });
