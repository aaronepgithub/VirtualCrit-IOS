...
//        }
        ...
        if data_to_display == "round" {
            ...
            lbl_Distance.text = "\(String(format:"%.2f", Round_PublicVars.distance)) Miles/Round"
        ...
        if data_to_display == "total" {
            ...
            lbl_Distance.text = "\(String(format:"%.2f", PublicVars.distance)) Miles/Total"
...
//MUST CHANGE TO ACTUAL TIME ELAPSED, NOT EVENT TIME
